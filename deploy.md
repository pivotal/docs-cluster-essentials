...
1. For air-gapped installation, download the bundle:
    ...
    - On macOS or Linux:
        ...
        $ IMGPKG_REGISTRY_HOSTNAME=registry.packages.broadcom.com \
          ...
          ./imgpkg copy \
            -b registry.packages.broadcom.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:34b73de251304538c08f8ccfb79950d205b04587ac1c0e7d32a58208c6b6c606 \
...
- For online installation, run:
    ...
    ```console
    export INSTALL_BUNDLE=registry.packages.broadcom.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:34b73de251304538c08f8ccfb79950d205b04587ac1c0e7d32a58208c6b6c606
...
- For online installation, run:
    ...
    set INSTALL_BUNDLE=registry.packages.broadcom.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:34b73de251304538c08f8ccfb79950d205b04587ac1c0e7d32a58208c6b6c606
...
cluster, you can upgrade to Cluster Essentials v1.7.7 using the following steps.
Running this upgrade updates the `kapp-controller` version on your cluster to `v0.48.9` and `secretgen-controller` version to `v0.15.6`.
...
1. Configure and run `install.sh`, which installs `kapp-controller` and `secretgen-controller` on your cluster:
    ...
    - On macOS or Linux:
        ...
        export INSTALL_BUNDLE=registry.packages.broadcom.com/tanzu-cluster-essentials/cluster-essentials-bundl@sha256:34b73de251304538c08f8ccfb79950d205b04587ac1c0e7d32a58208c6b6c606
        export INSTALL_REGISTRY_HOSTNAME=registry.packages.broadcom.com
        export INSTALL_REGISTRY_USERNAME=BROADCOM-REGISTRY-USERNAME
        export INSTALL_REGISTRY_PASSWORD=${MY_BROADCOM_SUPPORT_ACCESS_TOKEN}
