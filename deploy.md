...
1. Expand the **Cluster Essentials for VMWare Tanzu** section, and click release `1.8.3`.
...
Running this upgrade updates the `kapp-controller` version on your cluster to `v0.50.3` and `secretgen-controller` version to `v0.16.2`.
