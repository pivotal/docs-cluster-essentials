# Deploying Cluster Essentials v1.7.8

This topic tells you how to install, upgrade, and uninstall Cluster Essentials v1.7.8.
...
1. Choose a download according to your Kubernetes provider and operating system:
    ...
    - For macOS, download `tanzu-cluster-essentials-darwin-amd64-1.7.8.tgz`.
    - For Linux, download `tanzu-cluster-essentials-linux-amd64-1.7.8.tgz`.
    - For Windows, download `tanzu-cluster-essentials-windows-amd64-1.7.8.tgz`.
...
1. For air-gapped installation, download the bundle:
    ...
    - On macOS or Linux:
        ...
        $ IMGPKG_REGISTRY_HOSTNAME=cluster-essentials.packages.broadcom.com \
          ...
          ./imgpkg copy \
            -b cluster-essentials.packages.broadcom.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:f96fd5f4a1100f448f9b4a5a8d3313bae8db8aab6d44d99e7088bc9387625120 \
            --to-tar cluster-essentials-bundle-1.7.8.tar \
...
- For online installation, run:
    ...
    ```console
    export INSTALL_BUNDLE=cluster-essentials.packages.broadcom.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:f96fd5f4a1100f448f9b4a5a8d3313bae8db8aab6d44d99e7088bc9387625120
...
- For air-gapped installation:
    ...
    $ IMGPKG_REGISTRY_HOSTNAME=MY-REGISTRY \
      ...
      ./imgpkg copy \
        --tar cluster-essentials-bundle-1.7.8.tar \
        --to-repo MY-REGISTRY/cluster-essentials-bundle \
        --include-non-distributable-layers \
        --registry-ca-cert-path CA_PATH

    $ INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:f96fd5f4a1100f448f9b4a5a8d3313bae8db8aab6d44d99e7088bc9387625120 \
...
- For online installation, run:
    ...
    set INSTALL_BUNDLE=cluster-essentials.packages.broadcom.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:f96fd5f4a1100f448f9b4a5a8d3313bae8db8aab6d44d99e7088bc9387625120
...
- For air-gapped installation:
    ...
    set INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:f96fd5f4a1100f448f9b4a5a8d3313bae8db8aab6d44d99e7088bc9387625120
...
cluster, you can upgrade to Cluster Essentials v1.7.8 using the following steps.
Running this upgrade updates the `kapp-controller` version on your cluster to `v0.48.10` and `secretgen-controller` version to `v0.15.6`.
...
1. Configure and run `install.sh`, which installs `kapp-controller` and `secretgen-controller` on your cluster:
    ...
    - On macOS or Linux:
        ...
        export INSTALL_BUNDLE=cluster-essentials.packages.broadcom.com/tanzu-cluster-essentials/cluster-essentials-bundl@sha256:f96fd5f4a1100f448f9b4a5a8d3313bae8db8aab6d44d99e7088bc9387625120
        export INSTALL_REGISTRY_HOSTNAME=cluster-essentials.packages.broadcom.com
        export INSTALL_REGISTRY_USERNAME=BROADCOM-REGISTRY-USERNAME
        export INSTALL_REGISTRY_PASSWORD=${MY_BROADCOM_SUPPORT_ACCESS_TOKEN}
